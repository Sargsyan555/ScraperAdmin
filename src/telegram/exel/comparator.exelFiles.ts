...
type PriceInfo = { price: number | string; shopName: string; brand: string };
...
export async function compareItems(
  ...
  async function runNext() {
    ...
    try {
      ...
      const brandSklad = skladMatch?.['название детали'] ?? '';
